...
/**
 * @swagger
 * /api/v1/admin/auth/live-email-check:
 *   get:
...
/**
 * @swagger
 * /api/v1/admin/auth/must-change-password:
 *   post:
...
/**
 * @swagger
 * /api/v1/admin/auth/business/types:
 *   get:
